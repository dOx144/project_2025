          ...
          <div className="dark:bg-[#1E1E1E] dark:text-white bg-[#fff] min-h-screen flex flex-col">
            <div className="flex-grow flex flex-col justify-between items-center space-y-4 w-full max-w-4xl mx-auto px-4 lg:p-0">
                ...
                <div>
                    ...
                    <button onClick={() => navigate(-1)} className="px-5 py-2 ring-1 w-full cursor-pointer hover:ring-0 hover:bg-white hover:text-black transition-all duration-300 hover:shadow-xl">Go Back</button>
                </div>
    ...
    return ( 
         <div className="dark:bg-[#1E1E1E] dark:text-white bg-[#fff] min-h-screen flex flex-col">
            <div className="flex-grow flex flex-col justify-between items-center space-y-4 w-full max-w-4xl mx-auto px-4 lg:p-0">
                ...
                // Own profile
               <OwnProfile user={user} id = {id} userItems = {userItems} userLoggedIn = {userLoggedIn} VerifiedUser = {VerifiedUser} />
                ) : (
                // Public profile
