...
const Register = () => {
  ...
  return (
    <div className="dark:bg-[#1E1E1E] dark:text-white bg-[#e5e5e5a6] min-h-screen flex flex-col">
      <div className="flex-grow flex flex-col items-center justify-center">
        ...
        <main className="md:ring-1 px-8 py-12 w-full max-w-md space-y-6 rounded-xl bg-[#1e1e1ecf]  text-white">
          ...
          <div>
            ...
            <p>
              Join the OAH to surf through Thousands of items from antiques to
              basic
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            ...
            <div className="text-sm flex items-center gap-2">
              <input
                ...
                name="user_agreed"
              />
              <label htmlFor="user_agreed">
                I agree to our <a href="#"> terms and conditions.</a>
              </label>
            </div>

            <button
              className="ring-1 py-3 rounded-[8px] cursor-pointer dark:bg-white dark:text-black font-semibold bg-"
              type="submit"
            >
              Register
            </button>
      ...
      {response && (
        <pre className="mt-4 text-green-600">
