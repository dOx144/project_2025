    ...
    return ( 
        <div className="flex flex-col sm:flex-row  p-2 gap-2 hover:ring-1 transition-all *:transition-all **:transition-all group/mycard w-full justify-between">
            ...
            <div className="flex w-full flex-col space-y-2">
                ...
                <div >
                    <Link to={`/item/${title + "=it_id" + id}`} className="text-left text-2xl font-semibold w-full hover:underline underline-offset-4 hover:-translate-y-1 cursor-pointer">{title}</Link>
                ...
                <div>
                    ...
                    <div className="flex w-full justify-between items-center ">
                        <div>
                            <p>Current Bid Rs: <span className="font-semibold underline">{current_price}</span></p>
                        ...
                        :
                        <div>
                            <a className="underline group-hover/mycard:animate-bounce " href="/login">Login to add your bids</a>
                        </div>
                        }
                    </div>
