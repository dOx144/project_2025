    ...
    <div className="w-full p-2 flex items-center justify-between gap-4 **:transition-all *:transition-all">
      ...
      {userLoggedIn ? (
        ...
        <div className="flex items-center gap-2">
          <button>
            <a
              className="px-5 py-2 outline-1 rounded-md hover:bg-black hover:text-white dark:hover:text-black dark:hover:bg-white active:scale-95 "
              href="/login"
            >
              Login
            </a>
