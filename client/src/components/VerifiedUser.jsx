...
const VerifiedUser = ({ userLoggedIn }) => {
  ...
  return (
    <div>
      {/* add items */}
      <button onClick={() => setAddingItem(true)} className="ring-1 px-5 py-2">
        Create Listing
      </button>
          ...
          <div className="bg-slate-50/90 p-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`ring-1 min-w-1/2 ${
                        itemData.auction_duration_option === "custom"
                          ? "block"
                          : "hidden"
                      }`}
                    />
              ...
              <div className="p-2 space-y-2 w-full">
                ...
                <button
                  type="submit"
                  className="cursor-pointer bg-slate-800/85 text-white hover:bg-yellow-400 hover:ring-0 hover:font-bold transition-all p-2 ring-1 w-full hover:shadow-md"
                >
                  Create Listing
                </button>
              </div>
